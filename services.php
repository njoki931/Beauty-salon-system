...
<body>
	...
	<section class="hero-wrap hero-wrap-2" style="background-image: url('images/background6.jpg');" data-stellar-background-ratio="0.5">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<input type="name" name="name" class="form-control" placeholder="Name" value="<?php echo $name; ?>" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
					...
					<div class="d-flex gap-3 flex-wrap mx-auto">
						...
						?>
							<div class="card m-3" style="width: 14rem;">
								<img class="card-img-top" src="./images/serviceImages/<?php echo $image; ?>" alt="Card image cap">
								<div class="card-body">
