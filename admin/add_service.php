...
if (strlen($_SESSION['sid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES["image"]["name"])) {
      echo "<script>alert('Reading image')</script>";
    ...
    $query = mysqli_query($con, "insert into  tblservices(ServiceName,Cost, image) value('$sername','$cost', '$image')");
    if ($query) {
